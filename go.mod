...
require (
	...
	github.com/wasmerio/wasmer-go v1.0.0-beta2.0.20210113150733-ddc164edfd68
...
replace github.com/pingcap/parser => github.com/tidb-hackathon-2020-wasm-udf/parser v0.0.0-20210117064809-dd707937c6eb
